...
describe("the JavaScript language", function () {
    ...
    describe("has multiple ways to define and create objects", function () {
        ...
        it("may create objects also with the module pattern", function () {
            function createObject(initialScore, color) {
                ...
                return {
                    incrementScoreIn: function(args){
                        points += args;
                    },
                    score: function () {
                        return points;
    ...
    describe("commons patterns with functions and behaviors", function () {
        ...
        it("hoists variables the way you probably don't expect", function () {
            ...
            expect(generate()[2]()).toEqual(5);
            expect(generate()[3]()).toEqual(5);
            expect(generate()[4]()).toEqual(5);
        });
    ...
    context("has ways to simulate classes", function () {
        ...
        context("and the THIS keyword", function () {
            ...
            it("interpret the THIS when the function is executed", function () {
                var energy = 200;
                var lion = new Lion();
            ...
            it("implements the observer pattern (one2many)", function () {
                ...
                function Publisher() {
                    ...
                    this.informAllObservers = function () {
                        for (var i = 0, len = observersInfo.length; i < len; i++) {
                            var info = observersInfo[i];
                            console.log(info);
                            console.log(info.subscriber);
                            info.subscriber();
                        }
                    };
                }

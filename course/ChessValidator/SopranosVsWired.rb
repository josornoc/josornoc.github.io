...
describe SeriesMaster do
	...
	describe "#most_episodes" do
		it "Should state the quanity of episodes in total of the given serie" do
			numberOfResults = @seriesMaster.most_episodes("Friends")
			#I do not precicely how many episodes this serie have... got to update later after checking
		end
	end
end
